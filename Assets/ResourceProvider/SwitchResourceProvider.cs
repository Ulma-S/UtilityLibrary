...
namespace RitsGameSeminar {
    /// <summary>
    /// NintendoSwitch向けの動的リソース管理クラス.
    /// </summary>
    public class SwitchResourceProvider : IResourceProvider {
        ...
        public T LoadResource<T>(string fileName) where T : Object {
            ...
            var assetPath = Path.Combine(Application.streamingAssetsPath, "NintendoSwitch", assetName);
